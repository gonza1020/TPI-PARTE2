...
urlpatterns = [
    ...
    path('contacto/<str:apellido>/', views.contacto, name="contacto"),
    ...
    path('mostrar-articulo/<int:id>/', views.mostrar_articulo, name="articulo"),
    ...
    path('create-full-article/', views.create_full_article, name="create-full"),
